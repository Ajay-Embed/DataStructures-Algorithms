 ...
 *
 * The implementations extensively use recursion, as it's a litte elegant.
 ...
 * recommend you to wait for an iterative implementation for the same or
 * discuss if this implementation is suitable for you with your tech lead.
 *
 * If you're here to learn for some interview! Welcome, we hope you enjoy!
 *
 * And if you're a Tech Lead, we know there are better ways to do this, 
 * we're sorry for sticking to this one. We invite your suggestions :) 
 *
 */
